...
from services.category_service import create_category, get_categories, get_category, get_topics_for_category
...
def view_category(category_id: int, db: Session = Depends(get_db)):
    ...
    topics = get_topics_for_category(db, category_id)
